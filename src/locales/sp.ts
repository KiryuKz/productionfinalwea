...
const sp = {
    ...
    addProperty: {
        procTitle: '¿Que deseas hacer?',
        procSell: 'Vende',
        procRent: 'Arrienda',
        procManagement: 'Gestiona',
        selTitle: 'Selecciona tu tipo de propiedad',
        selHouse: 'Casa',
        selApartment: 'Departamento',
        selComercial: 'Comercial',
        selLand: 'Terreno',
        dirTitle: '¿Donde se encunetra tu propiedad?',
        dirRegion: 'Porfavor seleccione una región',
        dirComuna: 'Porfavor seleccione una comuna',
